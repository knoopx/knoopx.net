...
const Technology = () => {
  ...
  const [activeCategory, setActiveCategory] = useState<TechnologyCategory>(
    categories[0],
  );
                ...
                style={
                  {
                    ...
                    backgroundColor: isActive ? baseColor[6] : undefined,
            ...
            {technologies[activeCategory].sort().map((key, i) => (
              <div
                ...
                className={classNames("inline-block my-1", {
                  "mr-2": i !== technologies[activeCategory].length - 1,
                })}
              >
                <Pill>{key}</Pill>
              </div>
